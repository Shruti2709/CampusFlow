      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h2 className="font-display mt-3 text-4xl font-bold text-white leading-tight">
            Built to replace spreadsheets, not just digitize them.
          </h2>
          <p className="mt-5 text-slate-400 leading-relaxed">
            Most placement cells run on a patchwork of spreadsheets, WhatsApp
            groups, and email threads. CampusFlow gives every student, recruiter,
            and placement officer a single source of truth — so eligibility,
            applications, interviews, and offers stay in sync automatically.
          </p>
        </motion.div>
        ...
        >
          <h3 className="font-display text-2xl font-bold text-white">
            Ready to bring your placement cell online?
          </h3>
          <p className="mt-3 text-slate-300 text-sm">
            Set up your batch and start your first drive in minutes.
          </p>
          <Link
            to="/register"
